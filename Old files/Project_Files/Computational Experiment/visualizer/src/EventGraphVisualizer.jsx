...
export default function EventGraphVisualizer() {
  ...
  useEffect(() => {
    ...
    // When viewing gold standard, highlight the same ID directly
    const highlightId = viewMode === "custom" && hoveredNode && idMapping[hoveredNode]
      ? idMapping[hoveredNode]
      : hoveredNode;
    renderGraph(compareSvgRef.current, gold, computePositions(gold, w, h), { isCompare: true, highlightId });
  }, [compareMode, domain, customGraph, renderGraph, computePositions, hoveredNode, idMapping, viewMode]);
